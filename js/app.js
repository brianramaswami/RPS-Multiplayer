// Initialize Firebase
  var config = {
    apiKey: "AIzaSyC0CGggZpb8sNhUJsOj-RYB69j0Sdl04b4",
    authDomain: "rock-paper-sissors-2d54c.firebaseapp.com",
    databaseURL: "https://rock-paper-sissors-2d54c.firebaseio.com",
    projectId: "rock-paper-sissors-2d54c",
    storageBucket: "rock-paper-sissors-2d54c.appspot.com",
    messagingSenderId: "139153400781"
  };
...
function makeMove(event) {
		...
		if(playObj.plays.myPlay == undefined){
			makeMove(event);
		}	
...
function setLocalOpponent1Play() {
		if(data.player2.play !== 1) {
			...
			setTimeout(reckoning, 2000);
		} else {
			setTimeout(setLocalOpponent1Play, 2000);
		}
...
function setLocalOpponent2Play() {
		if(data.player1.play !== 1) {
			...
			setTimeout(setLocalOpponent2Play, 2000);
